      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16" style={{ alignItems: "center" }}>
        ...
        <div style={{ borderRadius: 20, overflow: "hidden", boxShadow: "0 8px 36px rgba(10,22,40,0.12)" }}>
          <Image
            ...
            alt="Active person recovering with FlexWave"
            width={1365}
            height={768}
        ...
        <div>
          ...
          <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(26px, 3.8vw, 44px)", fontWeight: 800, color: "#0C2240", letterSpacing: "-0.02em", lineHeight: 1.15, marginBottom: 16, marginTop: 0 }}>
            Precision-Engineered for Real Relief
          </h2>
          <p style={{ color: "#374151", lineHeight: 1.72, marginBottom: 28, fontSize: 16 }}>
            We don&apos;t just sell wellness devices — we design solutions. Every product is vetted for anatomical accuracy, ease of use, and long-term durability.
          </p>
